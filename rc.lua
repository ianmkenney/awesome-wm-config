...
-- table join is used to combine keybinds, this is later used when creating the widget
...
globalkeys = gears.table.join(
   ...
   awful.key({ modkey , "Shift" }, "Tab",
	 ...
	 awful.screen.focus_relative(1)
      ...
      {description = "Next screen", group = "hotkeys"}
   ),
   ...
   -- Layout manipulation
   awful.key({ modkey, "Shift"   }, "f", function () awful.client.swap.global_bydirection("right")    end,
      {description = "swap with right client", group = "client"}),

   awful.key({ modkey, "Shift"   }, "b", function () awful.client.swap.global_bydirection("left")    end,
   ...
   awful.key({ modkey, "Shift"   }, "p", function () awful.client.swap.global_bydirection("up")    end,
